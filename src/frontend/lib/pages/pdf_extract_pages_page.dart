...
/// Tool Landing Page for Extract PDF Pages (/extract-pages)
///
...
///   the dedicated status/progress route (/extract-pages/process) where Ad #2 lives.
class PdfExtractPagesPage extends StatefulWidget {
  final SelectedPdfFile? initialFile;

  const PdfExtractPagesPage({super.key, this.initialFile});

  @override
  State<PdfExtractPagesPage> createState() => _PdfExtractPagesPageState();
}

class _PdfExtractPagesPageState extends State<PdfExtractPagesPage> {
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Select specific pages to extract into a fresh, clean PDF document or individual pages packaged in a ZIP.',
                      style: TextStyle(
                        fontSize: 16,
                    ...
                    Wrap(
                      ...
                      children: [
                        _buildFeaturePill(
                          ...
                          label: 'Visual Page Selection',
                          isDark: isDark,
                        ),
                        _buildFeaturePill(
                          icon: Icons.splitscreen_rounded,
                          label: 'Single PDF or ZIP Package',
                          isDark: isDark,
                        ),
                        _buildFeaturePill(
                          icon: Icons.verified_user_outlined,
                          label: 'Zero Retention & Local RAM',
                          isDark: isDark,
                        ),
                      ],
                    ),
