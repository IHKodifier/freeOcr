...
/// Tool Landing Page for Split PDF (/split)
///
...
///   the dedicated status/progress route (/split/process) where Ad #2 lives.
class PdfSplitPage extends StatefulWidget {
  final SelectedPdfFile? initialFile;

  const PdfSplitPage({super.key, this.initialFile});
          ...
          children: [
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Separate one page or an entire set of pages for easy conversion into independent PDF files.',
                  style: TextStyle(
                    fontSize: 16,
                ...
                DropTarget(
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      color: _isDragging
                          ? (isDark ? const Color(0xFF1F242C) : const Color(0xFFEBF5FF))
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // Canonical Limits Notice (zero hardcoding)
                        Text(
            ...
            const AppFooter(currentRoute: '/split'),
          ],
        ),
      ),
    );
