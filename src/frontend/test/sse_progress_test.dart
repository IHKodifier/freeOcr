...
import 'package:free_ocr_frontend/services/api_service.dart';
...
void main() {
  ...
  testWidgets('OcrProgressView renders batch completion actions with View and Download buttons',
      (WidgetTester tester) async {
    final batchItems = [
      BatchFileItem(
        id: 'file_1',
    ...
    expect(find.textContaining('Download All as ZIP (2 Searchable PDFs)'), findsOneWidget);
  });
}
