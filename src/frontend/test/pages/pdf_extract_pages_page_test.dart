...
import 'package:free_ocr_frontend/pages/pdf_extract_pages_page.dart';
import 'package:free_ocr_frontend/pages/pdf_extract_pages_progress_page.dart';
...
void main() {
  ...
  testWidgets('PdfExtractPagesPage renders dropzone, header, and AdSense banner initially', (WidgetTester tester) async {
  ...
  testWidgets('PdfExtractPagesProgressPage renders document overview, page selector, quick actions, and extract button', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: PdfExtractPagesProgressPage(file: mockFile),
      ),
    );
    await tester.pumpAndSettle();
    ...
    expect(find.widgetWithText(ElevatedButton, 'Extract Pages'), findsOneWidget);
  });

  testWidgets('PdfExtractPagesProgressPage quick select buttons work', (WidgetTester tester) async {
    tester.view.physicalSize = const Size(1280, 1200);
    tester.view.devicePixelRatio = 1.0;
    addTearDown(tester.view.resetPhysicalSize);
  ...
  testWidgets('PdfExtractPagesProgressPage toggling card selects/deselects page', (WidgetTester tester) async {
    tester.view.physicalSize = const Size(1280, 1200);
    tester.view.devicePixelRatio = 1.0;
    addTearDown(tester.view.resetPhysicalSize);
