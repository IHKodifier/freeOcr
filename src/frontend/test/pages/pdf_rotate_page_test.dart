...
import 'package:free_ocr_frontend/pages/pdf_rotate_page.dart';
import 'package:free_ocr_frontend/pages/pdf_rotate_progress_page.dart';
...
void main() {
  ...
  testWidgets('PdfRotatePage renders dropzone, header, and AdSense banner initially', (WidgetTester tester) async {
  ...
  testWidgets('PdfRotateProgressPage renders document overview, page thumbnail cards, toolbar, and rotate buttons', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: PdfRotateProgressPage(file: mockFile),
      ),
    );
    await tester.pumpAndSettle();
    ...
    expect(find.widgetWithText(ElevatedButton, 'Save & Apply Rotation'), findsOneWidget);
  });

  testWidgets('PdfRotateProgressPage updates rotation angle when card rotate buttons tapped', (WidgetTester tester) async {
    tester.view.physicalSize = const Size(1280, 1200);
    tester.view.devicePixelRatio = 1.0;
    addTearDown(tester.view.resetPhysicalSize);
  ...
  testWidgets('PdfRotateProgressPage global toolbar rotates all pages and resets', (WidgetTester tester) async {
    tester.view.physicalSize = const Size(1280, 1200);
    tester.view.devicePixelRatio = 1.0;
    addTearDown(tester.view.resetPhysicalSize);
