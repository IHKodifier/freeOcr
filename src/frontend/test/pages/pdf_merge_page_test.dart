...
import 'package:free_ocr_frontend/pages/pdf_merge_progress_page.dart';
...
void main() {
  ...
  testWidgets('PdfMergePage renders dropzone, header, and AdSense banner initially', (WidgetTester tester) async {
  ...
  testWidgets('PdfMergePage renders added files in reorderable list and enables action', (WidgetTester tester) async {
    tester.view.physicalSize = const Size(1280, 1000);
    tester.view.devicePixelRatio = 1.0;
    addTearDown(tester.view.resetPhysicalSize);
  ...
  testWidgets('PdfMergeProgressPage renders AdSense banner, file manager, and action button', (WidgetTester tester) async {
    tester.view.physicalSize = const Size(1280, 1000);
    tester.view.devicePixelRatio = 1.0;
    addTearDown(tester.view.resetPhysicalSize);
    ...
    final actionButtonFinder = find.widgetWithText(ElevatedButton, 'Merge 2 PDFs');
    ...
    expect(find.text('Report2.pdf'), findsOneWidget);
    expect(find.widgetWithText(ElevatedButton, 'Add at least 2 files to merge'), findsOneWidget);
  });
}
