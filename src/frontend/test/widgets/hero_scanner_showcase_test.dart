...
import 'package:free_ocr_frontend/widgets/hero_scanner_showcase.dart';

void main() {
  testWidgets('HeroScannerShowcase renders engine badge, flow pill, and metric cards',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      const MaterialApp(
        home: Scaffold(
          body: HeroScannerShowcase(),
        ),
      ),
    );
