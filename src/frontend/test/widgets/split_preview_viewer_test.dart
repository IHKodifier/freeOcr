...
import 'package:free_ocr_frontend/widgets/split_preview_viewer.dart';
...
void main() {
  ...
  testWidgets('SplitPreviewViewer renders split panes and header controls', (WidgetTester tester) async {
  ...
  testWidgets('SplitPreviewViewer navigates pages correctly', (WidgetTester tester) async {
    tester.view.physicalSize = const Size(1280, 800);
    tester.view.devicePixelRatio = 1.0;
    addTearDown(tester.view.resetPhysicalSize);
  ...
  testWidgets('SplitPreviewViewer switches format tabs between txt and md', (WidgetTester tester) async {
    tester.view.physicalSize = const Size(1280, 800);
    tester.view.devicePixelRatio = 1.0;
    addTearDown(tester.view.resetPhysicalSize);
