...
> God node · 8 connections · [E:\Non_Office\Dev_Space\vibe_skool\freeOcr\src\backend\app\services\ocr_worker.py](file:///E:/Non_Office/Dev_Space/vibe_skool/freeOcr/src/backend/app/services/ocr_worker.py#L47)
...
sequenceDiagram
    ...
    participant P27 as _publish_event()
    participant P28 as _store_job()
    participant P29 as _get_tessdata_dir()
    participant P30 as repair_pdf()
    P0->>+ P1: calls
    P1-->>- P0: return
    P1->>+ P2: calls
    P2-->>- P1: return
