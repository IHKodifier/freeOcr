...
> God node · 10 connections · [E:\Non_Office\Dev_Space\vibe_skool\freeOcr\src\backend\app\services\pdf_composer.py](file:///E:/Non_Office/Dev_Space/vibe_skool/freeOcr/src/backend/app/services/pdf_composer.py#L115)
...
sequenceDiagram
    ...
    participant P7 as test_ocr_worker_resilient_cpu_fallback_on_gpu_timeout_or_error()
    participant P8 as test_process_ocr_job_ephemeral_file_cleanup_on_exception()
    participant P9 as test_ocr_worker_integrates_pdf_composer()
    participant P10 as test_ocr_worker_decryption_process()
    ...
    participant P15 as test_ocr_worker_unrepairable_pdf_integration()
    participant P16 as test_process_ocr_job_image_file()
