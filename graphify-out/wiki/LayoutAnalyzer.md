...
sequenceDiagram
    ...
    participant P4 as Validates rewarded ad view and stacks user limits (+20MB, +15 pages).     Reset
...
- [[Validates rewarded ad view and stacks user limits (+20MB, +15 pages).     Reset]] `INFERRED`
